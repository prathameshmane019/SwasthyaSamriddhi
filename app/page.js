    ...
    <span style={{ background: '-webkit-linear-gradient(45deg, #8A2BE2, #00BFFF)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
      ...
      <section className="relative py-6 my-10 flex flex-col md:flex-row items-center ">
        <div className="max-w-7xl mx-30 px-4 sm:px-6 lg:px-8 text-center md:w-2/3">
          <p className="text-md md:text-lg text-slate-900 dark:text-slate-50 mb-4">Centralised Health Record Management: Access, manage, and share your health records anytime, anywhere, eliminating the need for physical documents and ensuring continuity of care.</p>
        </div>
      ...
      Join now
    </span></h2> <p className="text-md md:text-lg  text-slate-900 dark:text-slate-50">Be Part of the Future of Healthcare: Join our growing community, explore our innovative services, and experience the future of healthcare with SwasthyaSamriddhi. Sign up today, stay connected, and take the first step towards empowered, personalized, and seamless healthcare access across India.
          </p>
        </div>
      </section>
</div>
