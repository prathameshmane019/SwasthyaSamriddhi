...
export default function Home() {
  return (
    <>
      ...
      <section className="relative h-[90vh] py-10 my-auto justify-center content-center items-center flex flex-row">
        {/* <img src="/bg-14.svg" alt="Illustration" className="absolute inset-0 object-cover  h-[70%] mx-auto  " /> */}
        <div className="w-1/2 z-10  mx-auto my-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className='mask1 w-1/2 ml-30 '>
          <img src='/404.jpg' height={700} width={700} className='mx-auto max-w-none'/>
        </div>
      </section>
