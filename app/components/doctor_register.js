      ...
      <form onSubmit={handleSubmit} className="w-full max-w-6xl bg-white shadow-md rounded-lg p-8">
        ...
        <div className="grid grid-cols-6 gap-6">
          ...
          <div className="col-span-3">
            <Input type="text" variant="bordered" label="Hospital Name" value={hospitalName} onChange={(e) => setHospitalName(e.target.value)} required />
          </div>
          <div className="col-span-2">
          ...
          <div className="col-span-2">
            <Input type="text" variant="bordered" label="Hospital Contact Number" value={hospitalContactNo} onChange={(e) => setHospitalContactNo(e.target.value)} required />
          </div>
          <div className="col-span-3">
