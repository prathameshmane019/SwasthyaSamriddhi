    ...
    if (id) {
      const fetchRecords = async () => {
        ...
        try {
          ...
          setUserHealthRecords(
            response.data.decryptedRecords.map((record) => ({
              ...record,
    ...
    <div className="h-screen overflow-y-scroll">
            ...
            <div className="px-3 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className=" rounded-lg p-2 border-1 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors duration-300">
                  ...
                  <p className="">
                    {user.fullname.firstName} {user.fullname.surName}
                  </p>
                </div>
                ...
                <div className=" rounded-lg p-2 border-1 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors duration-300">
                  ...
                  <p className="">{calculateAge(user.dob)}</p>
                </div>
      ...
      {selectedRecord && (
        <Modal
          ...
          classNames={{
            backdrop:
              "bg-gradient-to-t from-zinc-900 to-zinc-900/10 backdrop-opacity-20 overflow-y-scroll ",
          }}
        >
